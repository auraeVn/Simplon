...
{   // Début de la Classe
    ...
    public function get_questions($id_theme, $niveau)
    {
        $r = $this->bd->prepare("SELECT DISTINCT id_question FROM questions WHERE id_theme = :theme_id AND niveau = :level ORDER BY id_question");
