...
<div class="containerQuestions">
    ...
    <main id="mainQuestions">
        ...
        <form action="?controller=question&action=question&id_theme=<?= $id_theme ?>&niveau=<?= $niveau ?>&question=<?= $questionIndex + 1?>&id_reponse=<?=$reponse->id_reponse?>&type=<?=$reponse->type?>" id="formChoix">
